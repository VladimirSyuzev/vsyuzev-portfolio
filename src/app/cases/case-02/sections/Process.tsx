...
const STEPS = [
  ...
  { n: "03", title: "Эскизы", desc: "Проверяем несколько вариантов композиции и формы" },
...
export default function Process() {
  return (
    <div className="relative h-[624px] w-[1440px] overflow-clip bg-[#fafafa]">
      <div className="absolute left-[46px] top-[134px] flex items-center gap-[12px] whitespace-nowrap font-heading text-[32px] font-bold uppercase leading-[1.1] tracking-[0.96px]">
        <p className="text-[#008cff]">04</p>
        <p className="text-[#121212]">Процесс</p>
      </div>

      <div className="absolute left-[46px] top-[181px] flex w-[670px] gap-[12px] text-[14px] leading-[1.2] tracking-[0.28px] text-[#121212] opacity-70">
        <p className="w-[328px]">
      ...
      <img
        alt=""
        className="absolute left-[46px] top-[306px] h-[286px] w-[1348px] max-w-none"
        src={`${A}/process-stripes.svg`}
      />

      <div className="absolute left-[46px] top-[386px] flex h-[125px] gap-[12px]">
        {STEPS.map((s) => (
          <div
            key={s.n}
          ...
          >
            ...
            <p className="text-[11px] leading-[1.2] tracking-[0.66px] text-[#121212]">{s.desc}</p>
          </div>
        ))}
      </div>
