...
// блок закрепляется, скролл страницы на время анимации превращается в
// «скролл анимации» (scrub), голубой слой растёт с 16 до 640 и гаснет со
// 100 % до 80 % — после чего пин отпускает и скролл продолжается.
// Швов на входе/выходе нет: pinType:"transform" (без position:fixed —
// именно fixed давал дёрганье кадра), anticipatePin, а рост иконки — через
// transform:scale() (GPU-композитинг, без ре-растеризации SVG на каждом
// кадре — раньше анимировали width/height и SVG мерцал).
