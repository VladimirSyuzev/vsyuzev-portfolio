          ...
          <div className="hidden xl:block">
            <FullBleedScale width={1440} height={580} mode="grow" className="w-full">
              <div className="relative h-[580px] w-[1440px] overflow-clip bg-[#121212]">
                {/* Кейс под NDA: вместо оригинала — плоский WebP с уже
                    запечённым кропом, блюром и затемнением (см. case-01). */}
                {full ? (
                  ...
                  <img
                    alt={t.coverAlt}
                    className="absolute inset-0 size-full object-cover"
                    src="/cases/case-02/sections/cover-mockup-1440-nda.webp"
                  />
                )}
              </div>
            </FullBleedScale>
          ...
          <div className="w-full sm:hidden">
            <FullBleedScale width={375} height={356} mode="grow" className="w-full">
              <div className="relative h-[356px] w-[375px] overflow-clip bg-[#121212]">
                ...
                <img
                  alt={t.coverAlt}
                  className={full ? "absolute left-[-45px] top-0 h-[356px] w-[534px] max-w-none object-cover" : "absolute inset-0 size-full object-cover"}
                  src={full ? "/cases/case-02/sections/cover-mockup.png" : "/cases/case-02/sections/cover-mockup-375-nda.webp"}
                />
                <div
          ...
          <div className="hidden w-full sm:block lg:hidden">
            <FullBleedScale width={834} height={834} mode="grow" className="w-full">
              <div className="relative h-[834px] w-[834px] overflow-clip bg-[#121212]">
                ...
                <img
                  alt={t.coverAlt}
                  className={full ? "absolute left-[-282px] top-[-90px] h-[1008px] w-[1512px] max-w-none object-cover" : "absolute inset-0 size-full object-cover"}
                  src={full ? "/cases/case-02/sections/cover-mockup.png" : "/cases/case-02/sections/cover-mockup-834-nda.webp"}
                />
                <div
          ...
          <div className="hidden w-full lg:block xl:hidden">
            <FullBleedScale width={1280} height={828} mode="grow" className="w-full">
              <div className="relative h-[828px] w-[1280px] overflow-clip bg-[#121212]">
                ...
                <img
                  alt={t.coverAlt}
                  className={full ? "absolute left-[-50px] top-[-134px] h-[1095px] w-[1643px] max-w-none object-cover" : "absolute inset-0 size-full object-cover"}
                  src={full ? "/cases/case-02/sections/cover-mockup.png" : "/cases/case-02/sections/cover-mockup-1280-nda.webp"}
                />
                <div
