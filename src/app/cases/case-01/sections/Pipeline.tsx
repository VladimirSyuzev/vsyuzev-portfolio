// 04 Построение процесса — 1:1 из Figma (node 1961:32083). 12 карточек
// шагов на треке шире экрана (4068px) — оригинал просто клипует лишнее;
// здесь тот же трек сделан горизонтально прокручиваемым (overflow-x-auto)
// вместо обрезки — то же содержимое, доступное целиком, а не только
// видимый кусок.
...
export default function Pipeline() {
  return (
    <div className="relative h-[900px] w-[1440px] overflow-clip bg-[#121212]">
      ...
      <div className="absolute left-[46px] top-1/2 w-[1348px] -translate-y-1/2 overflow-x-auto">
