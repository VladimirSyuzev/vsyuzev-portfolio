    ...
    <div ref={sectionRef} className="relative h-[900px] w-full overflow-clip bg-[#121212]">
      <div className="relative mx-auto h-full w-[1440px]">
        ...
        {/* Стрелки-доодлы, указывающие на карточку "05" в состоянии покоя
            ...
            ИСПРАВЛЕНО: SVG были устаревшими — в Figma доодлы перерисованы
            (толщина обводки 8px вместо задеплоенных 6px, изменена сама
            кривая); пересобраны свежим экспортом из узлов 2285:45867/45868. */}
